...
#define STRING_CONFIG_H_AUTHOR "(Steven, Ender-3)" // Who made the changes.
 ...
 * Disabled for SKR 1.4 as built-in board pins for a Probe. 
 * Check in Marlin/src/inc/Conditionals_LCD.h, #define HOMING_Z_WITH_PROBE (Z_HOME_DIR < 0)
 */
