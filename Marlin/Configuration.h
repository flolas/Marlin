...
#define STRING_CONFIG_H_AUTHOR "(Felipe Lolas, Ender-3 Pro SKR 1.4T)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3P SKR-1.4T 2"
...
#define XY_PROBE_SPEED (133*60*1.5)
